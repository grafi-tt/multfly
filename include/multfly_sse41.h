...
static inline __m128i multfly_gen_impl_(const multfly_key *key, uint64_t id, uint32_t ctr) {
	...
	__m128i mns1 = _mm_set1_epi32(-1);
	ctr_hi = _mm_sub_epi32(ctr_hi, mns1);
	ctr_lo = _mm_sub_epi32(ctr_lo, mns1);
