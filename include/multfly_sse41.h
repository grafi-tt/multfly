...
// impl
//
static inline void multfly_chacha_round(__m128i *a, __m128i *b, __m128i *c, __m128i *d) {
...
static inline void multfly_chacha8_permute(__m128i *a, __m128i *b, __m128i *c, __m128i *d) {
	for (int i = 0; i < 8; i += 2) {
